...
export default function Courses() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-6 px-2 md:py-10 md:px-4">
      <h1 className="text-2xl md:text-3xl font-bold text-purple-700 mb-6 md:mb-8 text-center">Courses</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 md:gap-8 max-w-4xl mx-auto">
        {/* Course 1 */}
        <div className="bg-white rounded shadow p-4 md:p-6 flex flex-col">
